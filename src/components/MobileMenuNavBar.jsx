        ...
        <div className="mobile-nav-bar d-block col-sm-1 col-6 d-lg-none">
            <div className="mobile-nav-wrap">
                ...
                <div className="mobile-nav">
                    <button type="button" className="close-nav" aria-label="Close navigation">
                    ...
                    <div className="action-bar">
                        <a href="mailto:info@rswalls.es">
                            <i className="las la-envelope"/> info@rswalls.es
                        </a>
                        <a href="tel:+34 617 504 393">
                            <i className="fal fa-phone"/> +34 617 504 393 <br/>
                            +34 684 003 946
                        </a>
